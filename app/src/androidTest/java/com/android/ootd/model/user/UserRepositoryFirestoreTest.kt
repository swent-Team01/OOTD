...
class UserRepositoryFirestoreTest : FirestoreTest() {
  ...
  fun canAddFriendToUser() = runTest {
    ...
    userRepository.addFriend(user1.uid, user2.uid)

    val updatedUser = userRepository.getUser(user1.uid)
  ...
  fun canAddMultipleFriendsToUser() = runTest {
    ...
    userRepository.addFriend(user1.uid, user2.uid)
    userRepository.addFriend(user1.uid, user3.uid)
  ...
  fun addFriendThrowsExceptionWhenUserNotFound() = runTest {
    ...
    val exception =
        runCatching { userRepository.addFriend(nonExistentUserId, user1.uid) }.exceptionOrNull()
  ...
  fun canRemoveFriendFromUser() = runTest {
    ...
    userRepository.removeFriend(user1.uid, user2.uid)
  ...
  fun removeFriendThrowsExceptionWhenUserNotFound() = runTest {
    ...
    val exception =
        runCatching { userRepository.removeFriend(nonExistentUserId, user1.uid) }.exceptionOrNull()
  ...
  fun removeFriendThrowsExceptionWhenFriendNotFound() = runTest {
    ...
    val exception =
        runCatching { userRepository.removeFriend(user1.uid, nonExistentFriendId) }
            .exceptionOrNull()
  ...
  fun removeFriendDoesNothingWhenFriendNotInList() = runTest {
    ...
    userRepository.removeFriend(user1.uid, user3.uid)
  ...
  fun isMyFriendReturnsTrueForExistingFriend() = runTest {
    ...
    val isFriend = userRepository.isMyFriend(user1.uid, user2.uid)
  ...
  fun isMyFriendReturnsFalseForNonFriend() = runTest {
    ...
    val isFriend = userRepository.isMyFriend(user1.uid, user3.uid)
  ...
  fun isMyFriendReturnsTrueAfterAddingFriend() = runTest {
    ...
    val wasNotFriend = userRepository.isMyFriend(user1.uid, user2.uid)
    userRepository.addFriend(user1.uid, user2.uid)
    val isFriend = userRepository.isMyFriend(user1.uid, user2.uid)
  ...
  fun isMyFriendThrowsExceptionWhenUserNotFound() = runTest {
    ...
    val exception =
        runCatching { userRepository.isMyFriend(nonExistentUserId, user1.uid) }.exceptionOrNull()
  ...
  fun isMyFriendReturnsFalseWhenFriendUserDoesNotExist() = runTest {
    ...
    val isFriend = userRepository.isMyFriend(user1.uid, nonExistentFriendId)
